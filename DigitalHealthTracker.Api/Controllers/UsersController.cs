...
namespace DigitalHealthTracker.Api.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        // ============================================================
        // 1. DÜZELTİLEN KISIM: Role SORGUSU KALDIRILDI
        // ============================================================
        // GET: api/Users
        [HttpGet]
        public async Task<IActionResult> GetAll()
        {
            // ".Where(u => u.Role == "User")" sildik çünkü Users tablosu zaten öğrencileri tutuyor.
            var users = await _context.Users
                .OrderBy(u => u.Name)
                .Select(u => new
                {
                    u.Id,
                    // Web tarafı için FullName oluşturuyoruz
